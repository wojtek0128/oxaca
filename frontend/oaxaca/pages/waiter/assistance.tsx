...
import AssistanceList from "@/components/waiter/assistance/assistanceList";

/**
 * Displays all elements for the mapping /waiter/assistance.
 */
function Assistance() {
    return (
        <section>
            <div className="flex w-full min-h-full">
                ...
                <main className="flex flex-col flex-1 gap-6 py-5 2xl:py-5">
                    ...
                    {/* Context bar + Assistance requests */}
                    <AssistanceList/>
